...
public class TemporaryStorage extends CustomizedResultsetRowMapper<TemporaryStorage>
	...
	private short ntzstoragedatetime;

	@Column(name = "noffsetdstoragedatetime", nullable = false)
	private int noffsetdstoragedatetime;
	...
	public TemporaryStorage mapRow(ResultSet arg0, int arg1) throws SQLException {
		...
		objTemporaryStorage.setNoffsetdstoragedatetime(getInteger(arg0, "noffsetdstoragedatetime", arg1));
		objTemporaryStorage.setNtzstoragedatetime(getShort(arg0, "ntzstoragedatetime", arg1));
